...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,status, data_criacao, subtotal, taxa_frete, valor_total) values (1,'d8098d67-de95-4b83-9664-73f48f2c8681', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil','CRIADO', '2021-12-31 14:33:43', 298.90, 10, 308.90);
insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,status, data_criacao, subtotal, taxa_frete, valor_total)values (2,'9a850872-688a-4269-acd8-04e3a105f26f', 3, 2, 2, 1, '38400-111', 'Rua Florid', '2010', 'Casa 15', 'praça do abel','CRIADO', '2010-12-31 10:33:43', 89.20, 0, 104);
insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,status, data_criacao, subtotal, taxa_frete, valor_total)values (3,'044540a7-ccc0-420d-9628-96370ec2ebd8', 4, 2, 2, 1, '84756-480', 'Rua Geraldo barbosa', '2342', 'Casa', 'aperitif','CRIADO', '2011-12-31 9:33:43', 79.99, 0, 600);
insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,status, data_criacao, subtotal, taxa_frete, valor_total)values (4,'6fc81c02-bd02-4158-9129-5a2c493bb882', 1, 1, 2, 1, '78948-978', 'Rua Oscar franca', '2244', 'Casa 05', 'aperitif','CRIADO', '2023-12-31 8:33:43', 100.12, 0, 520);
insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,status, data_criacao, subtotal, taxa_frete, valor_total)values (5,'4c6567cb-331b-4d2e-a859-3f3885f9454d', 2, 3, 2, 1, '30124-486', 'Rua Oscar araripe', '1045', 'estabecimento comecial', 'Central norte','CRIADO', '2022-12-31 10:33:43', 820.29, 0, 1200);
