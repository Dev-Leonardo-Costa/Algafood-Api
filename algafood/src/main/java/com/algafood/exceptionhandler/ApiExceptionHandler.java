...
import com.algafood.domain.exception.ValidadorException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        if (rootCause instanceof InvalidFormatException){
            ...
            return handlerMethodArgumentTypeMismatch((MethodArgumentTypeMismatchException) rootCause, headers, status, request);
        }
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
        ...
        if (ex instanceof MethodArgumentTypeMismatchException) {
            return handlerMethodArgumentTypeMismatch(
    ...
    public ResponseEntity<Object> handleValidacaoException(ValidadorException ex, WebRequest request) {
